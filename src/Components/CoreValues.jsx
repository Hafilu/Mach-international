...
const CoreValues = ({ data, pageType }) => {
  return (
    <div>
      ...
      <div className="w-[85%] mx-auto mt-[200px]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3    w-[80%] mx-auto gap-y-10 gap-x-20   ">
          {data.coreValue?.map((value, index) => (
            <div key={value.id} className="flex items-start">
              ...
              <div>
                <h3
                  className={`${
                    pageType === "service" ? "text-xl" : "text-2xl"
